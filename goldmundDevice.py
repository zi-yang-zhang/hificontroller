...
class GoldmundStrategy:
    ...
    def onMainDevicePowerOn(self):
        logger.info("Main device is on, try set input to 2 and volumn to 60")
        ...
        logger.debug(self.__device__.send(setInput(2)))
        logger.debug(self.__device__.send(setVolumn(60)))
        pass
